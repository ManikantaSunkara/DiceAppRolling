package com.example.diceapprolling;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> {
            ...
            if (selectedId1 == R.id.side4) {
                maxValue = 4;
            } else if (selectedId1 == R.id.side6) {
                maxValue = 6;
            } else if (selectedId1 == R.id.side8) {
                maxValue = 8;
            } else if (selectedId1 == R.id.side10) {
                maxValue = 10;
            } else if (selectedId1 == R.id.side12) {
                maxValue = 12;
            } else if (selectedId1 == R.id.side20) {
                maxValue = 20;
            }
        ...
        button2.setOnClickListener(v -> {
            int selectedId12 =radioGroup.getCheckedRadioButtonId();

            if(selectedId12 ==R.id.side4){
                maxValue=4;
            }else if(selectedId12 ==R.id.side6){
                maxValue=6;
            }
            else if(selectedId12 ==R.id.side8){
                maxValue=8;
            }
            else if(selectedId12 ==R.id.side10){
                maxValue=10;
            }
            else if(selectedId12 ==R.id.side12){
                maxValue=12;
            }
            else if(selectedId12 ==R.id.side20){
                maxValue=20;
            }
            randomValue=(int)(Math.random()*maxValue)+1;
